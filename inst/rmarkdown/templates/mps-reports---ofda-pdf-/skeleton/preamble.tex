...
\fancyfoot[R]{\color{mpswine}{Office of Operational and Financial Data Analytics} \color{mpsyellow}{\textbar}\color{mpswine}{ \thepage}}
...
\renewenvironment{quote}{
	\colorlet{shadecolor}{mpspurple!10}
	\begin{shaded*}
